...
export const CommentIcon = ({ className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      className={cn("transition-200 fill-secondryTxt size-[17px]", className)}
    >
      <g>
...
export const RetweetIcon = ({ solid, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      className={cn(
        "transition-200 fill-secondryTxt size-[17px]",
        { "fill-green": solid },
        className,
      )}
    >
...
export const LikeIcon = ({ solid, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      className={cn(
...
export const BookmarkIcon = ({ solid, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      className={cn(
...
export const FollowIcon = ({ className }) => {
  return (
    <svg viewBox="0 0 24 24" className={cn("size-[18px]", className)}>
      <g>
