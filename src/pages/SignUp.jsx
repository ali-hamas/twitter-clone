          ...
          <form className="w-75 mx-auto space-y-6" onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="relative">
              <input type="text" id="name" maxLength={30} required 
                className={`text-field ${errors.name && "!border-red focus:!ring-red"}`}
                {...register("name", {
              ...
              />
              <label htmlFor="name" className={`text-field-label ${errors.name && "!text-red"}`}>Enter Name</label>
            ...
            <div className="relative">
              <input type="text" id="username" maxLength={30} required
                className={`text-field ${errors.username && "!border-red focus:!ring-red"}`}
                {...register("username", {
              ...
              />
              <label htmlFor="username" className={`text-field-label ${errors.username && "!text-red"}`}>Enter Username</label>
            ...
            <div className="relative">
              <button className="btn accent-btn w-full h-9">Sign Up</button>
            </div>
          </form>
        </div>
      </div>
