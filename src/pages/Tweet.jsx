...
const Tweet = () => {
  ...
  return (
    <>
      <Header title="Tweet" />
      {!loading ? (
        <article className="border-b border-b-border px-3 pt-3 md:px-4">
          ...
          <div className="flex py-3 w-full items-center justify-between">
            ...
            <button tooltip="Like" className="group tweet-btn lg:hover:bg-pink/30" ref={likeRef} onClick={handleLike}>
